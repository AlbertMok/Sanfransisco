...
export const useLocale = <L extends Locale, T extends LocaleComponentName<L> = LocaleComponentName<L>>(
  componentName: T,
...
export const useLocaleFormat = <L extends Locale, T extends LocaleComponentName<L> = LocaleComponentName<L>>(componentName: T) => {
