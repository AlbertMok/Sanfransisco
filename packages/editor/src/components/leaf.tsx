 ...
 */
const Leaf = (props: { isLast: boolean; parent: Element; leaf: Text; text: Text; renderPlaceholder?: PlaceholderRender }) => {
...
const MemoizedLeaf = React.memo(Leaf, (prev, next) => {
  return next.parent === prev.parent && prev.renderPlaceholder === next.renderPlaceholder && next.isLast === prev.isLast && next.text === prev.text
})
