  ...
  return (
    <span
      ...
      css={[
        ...
        step === 1 &&
          tw`bg-blue-40 border-blue-40 text-blue-60 dark:text-blue-30`,
        step === 2 &&
          tw`bg-yellow-40 border-yellow-40 text-yellow-60 dark:text-yellow-30`,
        step === 3 &&
          tw`bg-purple-40 border-purple-40 text-purple-60 dark:text-purple-30`,
        step === 4 &&
          tw`bg-green-40 border-green-40 text-green-60 dark:text-green-30`,
      ]}
      className="code-step"
    >
      {children}
...
const P = (p: JSX.IntrinsicElements['p']) => (
  <p tw="my-4 whitespace-pre-wrap" {...p} />
)
...
const OL = (p: JSX.IntrinsicElements['ol']) => (
  <ol tw="my-3 ml-6 list-decimal" {...p} />
)
const LI = (p: JSX.IntrinsicElements['li']) => (
  <li tw="mb-1 leading-relaxed" {...p} />
)
const UL = (p: JSX.IntrinsicElements['ul']) => (
  <ul tw="my-3 ml-6 list-disc" {...p} />
)

const Divider = () => (
  <hr tw="border-border dark:border-border-dark my-6 block border-b" />
)
  ...
  return (
    ...
    >
      <figure tw="my-8 flex justify-center">
        ...
        />
        {caption ? (
          <figcaption tw="mt-4 text-center leading-tight">{caption}</figcaption>
        ) : null}
      </figure>
